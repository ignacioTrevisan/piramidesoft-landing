...
import { UpdateConsultaStatusData, ConsultaResponse } from "@/interfaces/consulta";
import { verifyToken, getToken } from "@/app/lib/auth/jwt";

export async function updateConsultaStatus(data: UpdateConsultaStatusData): Promise<ConsultaResponse> {
  try {
